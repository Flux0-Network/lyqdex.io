...
export function Footer() {
  return (
    <footer className="bg-[#080910] border-t border-white/[0.05] py-12 px-6">
      ...
      <div className="max-w-5xl mx-auto mt-10 pt-6 border-t border-white/[0.05] flex flex-col sm:flex-row items-center justify-between gap-2 text-gray-600 text-xs">
