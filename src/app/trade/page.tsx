...
const defaultLayouts = {
  lg: [
    ...
    { i: "orderbook", x: 8, y: 0, w: 2, h: 14, minW: 2, minH: 6 },
    { i: "orderform", x: 10, y: 0, w: 2, h: 14, minW: 2, minH: 8 },
    { i: "positions", x: 0, y: 14, w: 8, h: 7, minW: 4, minH: 4 },
    { i: "trades", x: 8, y: 14, w: 2, h: 7, minW: 2, minH: 4 },
    { i: "wallet", x: 10, y: 14, w: 2, h: 7, minW: 2, minH: 4 },
  ],
  md: [
    { i: "chart", x: 0, y: 0, w: 7, h: 12, minW: 3, minH: 5 },
    { i: "orderbook", x: 7, y: 0, w: 3, h: 12, minW: 2, minH: 5 },
    { i: "orderform", x: 0, y: 12, w: 4, h: 10, minW: 2, minH: 6 },
    { i: "positions", x: 0, y: 22, w: 10, h: 6, minW: 4, minH: 4 },
    { i: "trades", x: 4, y: 12, w: 3, h: 10, minW: 2, minH: 4 },
    { i: "wallet", x: 7, y: 12, w: 3, h: 10, minW: 2, minH: 4 },
  ],
  sm: [
    { i: "chart", x: 0, y: 0, w: 6, h: 10, minW: 3, minH: 5 },
    { i: "orderform", x: 0, y: 10, w: 6, h: 8, minW: 2, minH: 6 },
    { i: "positions", x: 0, y: 18, w: 6, h: 6, minW: 3, minH: 4 },
    { i: "orderbook", x: 0, y: 24, w: 3, h: 8, minW: 2, minH: 5 },
    { i: "trades", x: 3, y: 24, w: 3, h: 8, minW: 2, minH: 4 },
    { i: "wallet", x: 0, y: 32, w: 6, h: 6, minW: 2, minH: 4 },
  ],
};
