  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-xl font-semibold text-white text-center mb-1">Wallet verbinden</h1>
        <p className="text-sm text-gray-500 text-center mb-8">
          Melde dich mit deiner Seed Phrase an.
          <br />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm text-gray-400 mb-1.5">Seed Phrase (12 Wörter)</label>
            <textarea
              value={seedPhrase}
              ...
              className="w-full bg-gray-900 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-violet-500/50 transition resize-none"
            />
          </div>
