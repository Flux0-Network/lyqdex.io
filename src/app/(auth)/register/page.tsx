    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-gray-400 mb-1.5">Passwort bestätigen</label>
            <input
              type="password"
              value={confirm}
          ...
          >
            {loading ? <IconLoader2 className="h-4 w-4 animate-spin" /> : "Registrieren"}
          </button>
        </form>

        <p className="mt-6 text-xs text-gray-600 text-center">
          Mit der Registrierung akzeptierst du unsere{" "}
          <Link href="#" className="text-gray-400 hover:text-white">AGB</Link> und{" "}
          <Link href="#" className="text-gray-400 hover:text-white">Datenschutzerklärung</Link>.
        </p>
      </div>
    </div>
  );
